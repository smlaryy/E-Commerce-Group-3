                    ...
                    <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden transition-all duration-300 transform hover:-translate-y-2 relative">
                        ...
                        <a href="{{ route('product.show', $product->slug) }}" class="block relative overflow-hidden bg-gradient-to-br from-orange-50 to-white z-10">
                            ...
                            <div class="w-full h-48 bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center relative overflow-hidden">
                                <div class="absolute inset-0 opacity-10">
                                    <div class="absolute top-0 right-0 w-32 h-32 bg-orange-400 rounded-full blur-2xl"></div>
                                </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center mb-3 text-sm">
                                ...
                                <span class="ml-2 text-gray-600 font-medium">{{ number_format($product->averageRating(), 1) }}</span>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5">
                    ...
                    <div class="group bg-white rounded-2xl shadow-md hover:shadow-2xl overflow-hidden transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        @if($product->stock < 10)
                            ...
                            <span class="bg-gradient-to-r from-red-500 to-red-600 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg flex items-center gap-1">
                    ...
                    <a href="{{ route('product.show', $product->slug) }}" class="block relative overflow-hidden bg-gradient-to-br from-gray-50 to-white">
                        ...
                        <div class="relative p-4">
                            <!-- Decorative Background -->
                            <div class="absolute inset-0 opacity-20">
                                <div class="absolute top-0 right-0 w-24 h-24 bg-blue-300 rounded-full blur-2xl"></div>
                                <div class="absolute bottom-0 left-0 w-20 h-20 bg-green-300 rounded-full blur-xl"></div>
                            </div>
                        ...
                        <div class="w-full h-48 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center relative overflow-hidden">
                            <div class="absolute inset-0 opacity-10">
                                <div class="absolute top-0 left-0 w-32 h-32 bg-gray-400 rounded-full blur-2xl"></div>
                            </div>
                            <svg class="relative w-20 h-20 text-gray-400 group-hover:scale-110 group-hover:-rotate-6 transition duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                            </svg>
                        </div>
                        @endif
                        <div class="absolute inset-0 bg-gradient-to-t from-black/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition"></div>
                    </a>
